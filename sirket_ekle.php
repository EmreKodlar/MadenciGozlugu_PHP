...
<div class="row">
 ...
 Hoşgeldiniz Sayın<i> Admin</i>  
   ...
   <div class=" col-sm-9  justify-content " >
    ...
    <H3>ŞİRKET EKLEME PANELİ</H3>
  
   <form method="post" action="sirket_ekle.php" name="formsekele" >

    <table class="table ">
    <tbody>
        <tr>
            <td><input class="form-control" type="text" name="sisim" id="sisim"  placeholder="Şirket İsmi Giriniz..." required /></td>
        </tr>
        <tr>
            <td><input class="form-control" type="text" name="ssehir" id="ssehir" placeholder="Şehir Giriniz..." required /></td>
        </tr>
        <tr>
            <td><input class="form-control" type="text" name="sbilgi" id="sbilgi" placeholder="Bilgileri Giriniz..." required /></td>
        </tr>
      
        <tr>
            <td><input type="submit"  name="syap"    value="ŞİRKET EKLE" class="btn btn-warning" /> </td>
        </tr>
        <tr bgcolor="#CCCCCC">
            <td>
        <?php
		...
		curl_setopt($curl, CURLOPT_URL, 'https://madencigozlugu.com.tr/api/sirketlerServis.php?token=emre');
 ...
 /*
	...
	*/ 
	...
	echo "Şirket Başarıyla Kaydedildi...";
