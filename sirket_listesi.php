...
<div class="row">
 ...
 <table id="datatable" class="table table-dark table-bordered" style="width:100%; table-layout: fixed; overflow-wrap: break-word; margin-left:auto;
      margin-right:auto; ">
         ...
         curl_setopt($cURLConnection, CURLOPT_URL, 'https://madencigozlugu.com.tr/api/sirketlerServis.php?token=emre');
         ...
         {
             echo '<tr><td>'. $emre['sisim'] . '</td><td>'. $emre['ssehir'] . '</td><td>'. $emre['sbilgi'] . '</td></tr>';
         }
			   ?>
